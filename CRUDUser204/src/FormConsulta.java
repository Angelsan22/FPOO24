...
public class FormConsulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Conslta de usuarios");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(138, 138, 138)
                        .addComponent(btnTodos, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(44, 44, 44)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTodosActionPerformed
        ...
        try{
            while(todos.next()){
                modeloT.addRow(new Object[]{todos.getInt("idUsuarios"), todos.getString("Nombre"), todos.getString("Correo"), todos.getString("Contraseña")});
            }
        }
        catch (SQLException x){
            System.out.println("Error al llamar la tabla" + x.getMessage());
        }
